...
export default function PinnedVideos() {
  return (
    <section className="xl:w-11/12 md:h-[600px] flex flex-col items-center md:justify-evenly pt-6 md:pt-10">
      <section className="w-fit md:w-full h-[600px] md:h-fit flex flex-col md:flex-row items-center justify-between md:justify-evenly pt-10 md:pb-10 rounded-xl relative">
        ...
        <a href="https://www.youtube.com/watch?v=WVEqX8DL4KE" target="_blank">
          <Image
            ...
            width={300}
            className="md:w-[170px] lg:w-[200px] xl:w-[300px] rounded-xl cursor-pointer"
          />
        </a>
      ...
      <section className="w-fit md:w-full h-[600px] md:h-fit flex flex-col md:flex-row items-center justify-between md:justify-evenly pt-10 mt-10 md:mt-0 md:pb-10 rounded-xl relative">
