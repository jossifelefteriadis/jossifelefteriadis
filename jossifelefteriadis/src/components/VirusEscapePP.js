...
const VirusEscapePP = () => (
  <section className="PrivacySection">
    ...
    <p>
      ...
      Terms and Conditions, which are accessible at Virus Escape unless
    ...
    <p>
      ...
      not limited to We don't collect any information from you. The information
      that I request will be retained on your device and is not collected by me
      in any way.
    </p>
    <p>
      <br />
